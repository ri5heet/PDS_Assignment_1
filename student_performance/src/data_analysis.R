...
clean_StudentsPerformance_data <- read.csv("C:/Users/yrish/OneDrive/Desktop/pds q2/clean_StudentsPerformance_data.csv")
...
plot(clean_StudentsPerformance_data$reading.score, clean_StudentsPerformance_data$writing.score, pch = 10, cex = 1, frame = FALSE, xlab = "READING SCORE" , ylab = "WRITING SCORE", main="Scatterplot Reading & Writing",col='red')
# 1.2
par(mar = c(3, 2, 2, 1) + 0.1)
...
# 1.3
par(mar = c(3, 2, 2, 1) + 0.1)
plot(clean_StudentsPerformance_data$math.score, clean_StudentsPerformance_data$writing.score, pch = 10, cex = 1, frame = FALSE, xlab = "MATH SCORE" , ylab = "WRITING SCORE", main="Scatterplot Math & Writing",col='pink')
