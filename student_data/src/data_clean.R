...
raw_student_data <- read.csv("C:/Users/yrish/OneDrive/Desktop/pds q1/raw_student_data.csv")
...
write.csv(clean_student_data, "C:/Users/yrish/OneDrive/Desktop/pds q1/clean_student_data.csv")
