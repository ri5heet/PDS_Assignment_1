...
clean_student_data <- read.csv("C:/Users/yrish/OneDrive/Desktop/pds q1/clean_student_data.csv")
...
capture.output(t_test_frailty, file = "C:/Users/yrish/OneDrive/Desktop/pds q1/test_results.txt")
